...
namespace EShop.Server.Migrations
{
    ...
    [Migration("20221127200023_CartItems")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EShop.Shared.CartItem", b =>
                {
            ...
            modelBuilder.Entity("EShop.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EShop.Shared.ProductVariant", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EShop.Shared.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EShop.Shared.ProductVariant", b =>
                {
                    b.HasOne("EShop.Shared.Product", "Product")
                        .WithMany("Variants")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EShop.Shared.ProductType", "ProductType")
                        .WithMany()
